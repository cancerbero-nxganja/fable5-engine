...
<!-- ════════════════════════════════════════════════════════════════
     FABLE 5 ENGINE — v1.10
     Generado: 2026-07-09 · Última reingeniería: 2026-07-15 (run 10)
     Experimentos completados: 10 (EXP-01 … EXP-10) — FASE 1 completa · FASE 2 en curso
     Próxima mejora programada: EXP-11
     ════════════════════════════════════════════════════════════════ -->
...
**Tipología del oráculo (generalización, EXP-07; ampliada EXP-10):** la pregunta que abre cualquier dominio nuevo no es solo "¿hay oráculo?" sino "¿el oráculo es **honesto** (código: ejecuta y confía), **ausente** (datos, arquitectura: sustituye por protocolo adversarial), **adversarial** (trading: interroga al propio oráculo) o **diferido** (evaluación de resultados: la replicación existe y es honesta, pero no está disponible al momento de decidir — sustituye por interrogatorio del procedimiento + deflación por selección + posterior, y deja la replicación como cierre)?" — la naturaleza del oráculo fija el método antes que cualquier detalle del dominio.
